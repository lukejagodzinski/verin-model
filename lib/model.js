...
ModelDefinition.prototype.behaviour = function (behaviourName, behaviourOptions) {
  ...
  // SETTER
  // Check if behaviour exists in the behaviours list `Behaviours`.
...
ZeitgeistModel = function (collection, modelConstructor) {
  ...
  var Model = function (attrs) {
    ...
    _.each(modelDefinition._behaviours, function (behaviourDefinition) {
      BehaviourUtilities.extendObject(self, behaviourDefinition);
    });
  ...
  _.each(modelDefinition._behaviours, function (behaviourDefinition) {
    BehaviourUtilities.extendPrototype(Model.prototype, behaviourDefinition);
  });
