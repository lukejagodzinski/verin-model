...
ModelBase.extend = function (definition) {
  var self = this;
  ...
  if (_.has(definition, 'fields')) {
    _.extend(extendOptions.object, definition.fields);
  }
  _.each(definition.behaviors, function (behavior) {
    _.extend(extendOptions.object, behavior.fields);
  });

  _.extend(extendOptions.prototype, definition.methods);
  _.each(definition.behaviors, function (behavior) {
    _.extend(extendOptions.prototype, behavior.methods);
  });

  // Extending definition object.
  // TODO: Extend all the properties of definition with the new definition object.
  console.log(self.prototype._definition, definition);
  definition = _.extend({}, self.prototype._definition, definition);
  _.extend(extendOptions.prototype, {
